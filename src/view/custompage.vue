<template>
    <el-card>
        ...
        <div style="margin: 10px 20px;">
            <el-tabs v-model="activeName" tab-position="top" @tab-change="handleTabClick">
                        ...
                        <div class="mat-10">
                            <div v-if="isManeger" style="margin-bottom: 20px;">
                                <el-alert title="管理运营教师和同学" type="success" effect="dark" :closable="false"
                                    description="下方展示当前主题的运营教师和同学~" style="background-color: rgb(23, 124, 176) !important;"/>
                                <br>
                            ...
                            <div style="margin-bottom: 20px;">
                                <el-alert title="论坛话题" type="success" effect="dark" :closable="false"
                                    description="你可以在下方添加或删除当前主题的论坛话题~"  style="background-color: rgb(23, 124, 176) !important;"/>
                                <br>
                            ...
                            <div v-if="isTeacherOrOperator" style="margin-bottom: 20px;">
                                <el-alert title="沙龙活动" type="success" effect="dark" :closable="false"
                                    description="你可以在下方添加或删除当前主题的沙龙活动~" style="background-color: rgb(23, 124, 176) !important;" />
                                <br>
                            ...
                            <div v-if="isTeacherOrOperator" style="margin-bottom: 20px;">
                                <el-alert title="主题标签" type="success" effect="dark" :closable="false"
                                    description="你可以在下方添加或删除当前主题的标签~"  style="background-color: rgb(23, 124, 176) !important;"/>
                                <br>
                            ...
                            <div v-if="isTeacherOrOperator" style="margin-bottom: 20px;">
                                <el-alert title="编辑主题概述" type="success" effect="dark" :closable="false"
                                    description="你可以在点击下方按钮编辑主题概述~"  style="background-color: rgb(23, 124, 176) !important;"/>
                                <div style="margin-top: 10px; margin-bottom: 10px;">
                    ...
                    <el-card class="box-card">
                        <div class="mat-10">
                            <el-alert title="主题概述" type="success" effect="dark" :closable="false"
                                description="下方展示当前主题的介绍~" style="background-color: rgb(23, 124, 176) !important;"/>
                            <br>
                            <div id="overview" style="line-height: 30px !important;" v-html="overview"></div>
                        </div>
                    </el-card>
                </el-tab-pane>
                <el-tab-pane label="论坛话题" name="forum">
                    <el-card class="box-card">
                        ...
                        <div class="mat-10">
                            <el-alert title="论坛话题" type="success" effect="dark" :closable="false"
                                description="下方展示当前主题的论坛话题列表~" style="background-color: rgb(23, 124, 176) !important;" />
                            <br>
                ...
                <el-tab-pane label="沙龙活动" name="activity">
                    <el-card class="box-card">
                        ...
                        <div class="mat-10">
                            <el-alert title="沙龙活动" type="success" effect="dark" :closable="false"
                                description="下方展示当前主题的沙龙活动列表~" style="background-color: rgb(23, 124, 176) !important;" />
                            <br>
                    ...
                    <el-card class="box-card">
                        <div class="mat-10">
                            <el-alert title="网络构建情况" type="success" effect="dark" :closable="false"
                                description="下方展示当前主题的网络构建情况~" style="background-color: rgb(23, 124, 176) !important;"/>
                            <br>
                            <el-alert title="网络构建概览" type="info" :closable="false" />
                            <el-tabs style="margin-top: 10px;" type="border-card" v-model="networkActiveName"
                                @tab-change="handleNetworkClick">
                                <el-tab-pane label="社会网络" name="socialNetwork">
                                    <el-row :gutter="20">
                                        <el-col :span="6"></el-col>
                                        <el-col :span="6">
                                            <el-select v-model="socialNetworkTypeSelect" placeholder="请选择">
                                                <!-- <el-option label="关注网络" value="关注"></el-option> -->
                                                <el-option label="点赞网络" value="点赞"></el-option>
                                                <el-option label="回复网络" value="回复"></el-option>
                                            </el-select>
                                        </el-col>
                                        <el-col :span="6">
                                            <el-select v-model="socialNetworkDisplaySelect" placeholder="请选择">
                                                <el-option label="网络图" value="none"></el-option>
                                                <el-option label="和弦图" value="circular"></el-option>
                                            </el-select>
                                        </el-col>
                                        <el-col :span="6">
                                ...
                                <el-tab-pane label="信息网络" name="informNetwork">
                                    <el-row :gutter="20">
                                        ...
                                        <el-col :span="6"></el-col>
                                        <el-col :span="6">
                                            <el-select v-model="infolNetworkDisplaySelect" placeholder="请选择">
                                                <el-option label="网络图" value="none"></el-option>
                                                <el-option label="和弦图" value="circular"></el-option>
                                            </el-select>
                                        </el-col>
                            ...
                            <el-alert title="内容生产情况" type="success" effect="dark" :closable="false"
                                description="下方展示当前主题的内容生产情况~" style="background-color: rgb(23, 124, 176) !important;"/>
                            <br>
                            <el-alert title="内容生产概览" type="info" :closable="false" />
                            ...
                            <el-table :data="wayfinding.generateContentList" style="width: 100%;">
                                <el-table-column prop="generateContentCat" label="类型" width="80" :filters="[
                                        { text: '博客', value: '博客' },
                                        { text: '资源', value: '资源' },
                                        { text: '案例', value: '案例' },
                                    ]" :filter-method="filterCat" filter-placement="bottom-end" />
                                <el-table-column prop="generateContentTag" label="标签" width="120"
                    ...
                    <el-card class="box-card">
                        ...
                        <div class="mat-10">
                            <el-alert title="主题动态" type="success" effect="dark" :closable="false"
                                description="下方展示当前主题的相关动态情况~" style="background-color: rgb(23, 124, 176) !important;" />
                            <br>
                            <el-row>
                                <el-col :span="18">
                                </el-col>
...
export default {
    ...
    data() {
        return {
            ...
            themeId: parseInt(zrz_single.post_id) != 'undefind' ? parseInt(zrz_single.post_id) : 556572,
            // eslint-disable-next-line no-undef
            themeName: zrz_single.post_title != 'undefind' ? zrz_single.post_title : '主题名称',
            // eslint-disable-next-line no-undef
            userId: zrz_single.user_id != 'undefind' ? zrz_single.user_id : 88,
            editUrl: '',
            isManeger: false,
            ...
            forumTable: [],
            activityList: [],
            socialNetworkTypeSelect: "点赞",
            socialNetworkDisplaySelect: 'none',
            socialNetworkData: [], //社交网络数据
            socialNetworkRelateMeSelect: "全部",
            infolNetworkData: [], //信息网络数据
            infolNetworkRelateMeSelect: "全部",
            infolNetworkDisplaySelect: 'none',
            wayfinding: {
                'recommendUserList': [],
                'generateContentList': [],
    ...
    watch: {
        ...
        socialNetworkTypeSelect(newVal, oldVal) {
            if (newVal != oldVal){
                this.getSocialNetworkData();
            }
        },
        socialNetworkRelateMeSelect() {
            this.drawSocialNetwork();
        },
        socialNetworkDisplaySelect() {
            this.drawSocialNetwork();
        },
        infolNetworkRelateMeSelect(){
            this.drawInfolNetwork();
        },
        infolNetworkDisplaySelect(){
            this.drawInfolNetwork();
        }
    },
    methods: {
        ...
        onAddTagToBackend() {
            ...
            const url = this.baseUrl + "cmooc_theme_manege_add_tag" + "&themeId=" + this.themeId + "&tag=" + encodeURIComponent(JSON.stringify(temp));
            fetch(url)
                .then(response => response.json())
                .then(data => {
                    if (data.code == 200) {
        ...
        handleNetworkClick(tab) {
            if (tab == "socialNetwork" && this.socialNetworkData.length == 0) {
                this.getSocialNetworkData();
            } else if (tab == "informNetwork" && this.infolNetworkData.length == 0) {
                this.getInfolNetworkData();
            }
        },
        handleTabClick(tab) {
            if (tab == "overview") {
        ...
        drawSocialNetwork() {
            ...
            if (this.socialNetworkRelateMeSelect == '全部') {
                graph.nodes = this.socialNetworkData.nodes;
                graph.links = this.socialNetworkData.links;
                graph.categories = this.socialNetworkData.categories;
            } else if (this.socialNetworkRelateMeSelect == '与我相关') {
                graph.nodes = this.socialNetworkData.current_user_nodes;
                graph.links = this.socialNetworkData.current_user_links;
                graph.categories = this.socialNetworkData.categories;
            }
                ...
                tooltip: {
                    ...
                    formatter: (params) => {
                        ...
                        if (params.dataType === 'edge') {
                            return params.data.source_name + '--' + this.socialNetworkTypeSelect + '-->' + params.data.target_name
                        } else if (params.dataType === 'node') {
                            return '<span>昵称：</span>' + params.data.user_name +
                                '<br /><span>职业：</span>' + params.data.category +
                                '<br /><span>主动性：</span>' + params.data.out_count +
                                '<br /><span>吸引力：</span>' + params.data.in_count +
                                '<br /><span>网络类型：</span>' + this.socialNetworkTypeSelect +
                                '<br /><span>网络位置：</span>' + (params.data.place == 1 ? '核心联通者' : params.data.place == 2 ? '主要联通者' : '边缘联通者')
                        }
                    }
                },
                legend: [
                ...
                series: [
                    {
                        top: 50,
                        type: 'graph',
                        layout: this.socialNetworkDisplaySelect,
                        data: graph.nodes,
                        links: graph.links,
                        categories: graph.categories, //节点分类
                        focusNodeAdjacency: true, //是否在鼠标移到节点上的时候突出显示节点以及节点的边和邻接节点。
                        edgeSymbol: ['circle', 'arrow'], //边的箭头
                        edgeSymbolSize: [4, 6], //边的箭头大小
            ...
            myChart.on('click', function (param) {
                if (param.dataType === 'node') {
                    window.open('https://cmooc.bnu.edu.cn/user/' + param.data.user_id);
                }
            });
        ...
        getSocialNetworkData() {
            // to do 
            this.$message({
                message: '正在加载社会网络数据，请稍后',
                type: 'warning'
            });
            var url = this.baseUrl + 'cmooc_theme_get_social_network&themeId=' + this.themeId + '&networkType=' + this.socialNetworkTypeSelect;
            fetch(url)
                .then(response => response.json())
                .then(data => {
                    if (data.code == 200) {
                        this.socialNetworkData = data.data;
                        if(this.socialNetworkData.nodes.length == 0){
                            this.$message({
                                message: '当前网络中没有节点。',
                                type: 'error'
                            })
        ...
        drawInfolNetwork(){
            // id social-network   info-network
            var chartDom = document.getElementById('info-network');
            chartDom.removeAttribute('_echarts_instance_');
            var myChart = echarts.init(chartDom);
            var option;
            ...
            if (this.infolNetworkRelateMeSelect == '全部'){
                graph.nodes = this.infolNetworkData.nodes;
                graph.links = this.infolNetworkData.links;
                graph.categories = this.infolNetworkData.categories;
            }else if(this.infolNetworkRelateMeSelect == '与我相关'){
                graph.nodes = this.infolNetworkData.current_user_nodes;
                graph.links = this.infolNetworkData.current_user_links;
                graph.categories = this.infolNetworkData.categories;
            }
            ...
            option = {
                tooltip: {
                    ...
                    formatter: (params) => {
                        if (params.dataType === 'edge') {
                            return params.data.source_name + '--' + params.data.linkType + '-->' + params.data.target_name
                        } else if (params.dataType === 'node') {
                            var temp = params.data.category === '学习者' ? '<span>昵称：</span>' : params.data.category === '文章' ? '<span>标题：</span>' : '<span></span>';
                            return temp + params.data.name +
                                '<br /><span>主动性：</span>' + params.data.out_count +
                                '<br /><span>吸引力：</span>' + params.data.in_count
                        }
                    }
                ...
                series: [
                    {
                        top: 50,
                        type: 'graph',
                        layout: this.infolNetworkDisplaySelect,
                        data: graph.nodes,
                        links: graph.links,
                        categories: graph.categories, //节点分类
                        focusNodeAdjacency: true, //是否在鼠标移到节点上的时候突出显示节点以及节点的边和邻接节点。
        ...
        getInfolNetworkData() {
            this.$message({
                message: '正在加载信息网络数据，请稍后',
                type: 'warning'
            });
            var url = this.baseUrl + 'cmooc_theme_get_infol_network&themeId=' + this.themeId;
            fetch(url)
            .then(response => response.json())
                .then(data => {
                    if (data.code == 200) {
                        this.infolNetworkData = data.data;
                        if(this.infolNetworkData.nodes.length == 0){
                            this.$message({
                            message: '当前网络中没有节点。',
                            type: 'error'
                        })
